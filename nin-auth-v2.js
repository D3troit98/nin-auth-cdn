...
let capturedPhoto = null; // Variable to store the captured image
...
function takePhoto() {
    ...
    capturedPhoto = canvas.toDataURL("image/png"); // Store the image as base64

    // Show the captured image
    document.querySelector("#photo-preview").src = capturedPhoto;
...
function usePhoto() {
    if (capturedPhoto) {
        console.log("Processing photo:", capturedPhoto);
        // Perform necessary actions with the captured photo (e.g., upload it)
    } else {
